...
import memitem from "@/components/room/memitem"
...
export default {
  ...
  data() {
    return {
      ...
      findGroupText: "Find a user that is currently groupless by scrolling through the list below, or filtering your search using the search bar filter tool",
